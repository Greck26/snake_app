...
class WelcomeScreen(Screen):
	...
	instruction_popup = ObjectProperty(None)
	...
	def show_popup_inst(self):
		self.instruction_popup = InstructionPopup()
		self.instruction_popup.open()
...
class InstructionPopup(Popup):
	instruction_text = ("This snake is a little different from the classic snake. \n \
You have 10 steps out to eat fruit. \n \
 \n \
You can complete the game in three ways: \n \
-Close the application \n \
-Crash yourself \n \
-Move fingers snake forward in the opposite direction. \n \
\n \
To configure the settings of the game - go to options.")	
	def on_menu(self):
		return
